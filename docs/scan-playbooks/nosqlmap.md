...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner NoSQLMap.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con NoSQLMap.
...
## Errori comuni
- Endpoint non vulnerabili possono apparire sospetti in assenza di contesto.
...
- Scanner/tool: https://github.com/codingo/NoSQLMap
