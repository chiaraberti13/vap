...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Arjun.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Arjun.
...
## Errori comuni
- Parametri candidati non sempre corrispondono a input realmente processati.
...
- Scanner/tool: https://github.com/s0md3v/Arjun
