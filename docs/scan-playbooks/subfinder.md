...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Subfinder.
- **Categoria:** Recon
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Subfinder.
...
## Errori comuni
- Dati OSINT non sempre aggiornati o completi.
...
- Scanner/tool: https://docs.projectdiscovery.io/tools/subfinder/overview
