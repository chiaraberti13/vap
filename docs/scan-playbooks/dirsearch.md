...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Dirsearch.
- **Categoria:** Web
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Dirsearch.
...
## Errori comuni
- Path protetti possono risultare come falsi negativi.
...
- Scanner/tool: https://github.com/maurosoria/dirsearch
