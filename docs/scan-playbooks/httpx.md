...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner httpx.
- **Categoria:** Recon
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con httpx.
...
## Errori comuni
- Servizi intermittenti possono generare risultati non deterministici.
...
- Scanner/tool: https://docs.projectdiscovery.io/tools/httpx/overview
