...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner theHarvester.
- **Categoria:** Recon
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con theHarvester.
...
## Errori comuni
- Le fonti OSINT possono restituire asset obsoleti o rumorosi.
...
- Scanner/tool: https://github.com/laramies/theHarvester
