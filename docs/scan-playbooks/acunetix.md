...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Acunetix.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Acunetix.
...
## Errori comuni
- Euristiche proprietarie possono richiedere tuning per ridurre rumore.
...
- Scanner/tool: https://www.acunetix.com/support/docs/
