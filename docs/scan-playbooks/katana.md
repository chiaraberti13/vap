...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Katana.
- **Categoria:** Recon
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Katana.
...
## Errori comuni
- Crawler può perdere route protette da autenticazione o feature flag.
...
- Scanner/tool: https://docs.projectdiscovery.io/tools/katana/overview
