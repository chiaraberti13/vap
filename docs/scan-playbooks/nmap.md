...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Nmap.
- **Categoria:** Infra
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Nmap.
...
## Errori comuni
- Servizi filtrati o banner obfuscati possono alterare risultati.
...
- Scanner/tool: https://nmap.org/docs.html
