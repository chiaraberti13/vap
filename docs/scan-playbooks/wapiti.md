...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Wapiti.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Wapiti.
...
## Errori comuni
- Coverage limitata da crawling incompleto.
...
- Scanner/tool: https://wapiti-scanner.github.io/
