...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Nessus.
- **Categoria:** Infra
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Nessus.
...
## Errori comuni
- Plugin feed e credenziali influenzano profondità e accuratezza.
...
- Scanner/tool: https://docs.tenable.com/nessus/
