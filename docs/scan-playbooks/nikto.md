...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Nikto.
- **Categoria:** Web
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Nikto.
...
## Errori comuni
- Check storici non sempre rilevanti per stack moderni.
...
- Scanner/tool: https://cirt.net/Nikto2
