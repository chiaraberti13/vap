...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner wafw00f.
- **Categoria:** Recon
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con wafw00f.
...
## Errori comuni
- Rilevamento WAF basato su signature può essere ambiguo.
...
- Scanner/tool: https://github.com/EnableSecurity/wafw00f
