...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Nuclei.
- **Categoria:** Web
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Nuclei.
...
## Errori comuni
- Template signatures dipendenti da versione applicativa.
...
- Scanner/tool: https://docs.projectdiscovery.io/tools/nuclei/overview
