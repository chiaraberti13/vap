...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Dalfox.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Dalfox.
...
## Errori comuni
- Payload XSS riflessi possono non essere sfruttabili in contesto reale.
...
- Scanner/tool: https://dalfox.hahwul.com/
