...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner OWASP ZAP.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con OWASP ZAP.
...
## Errori comuni
- Regole passive possono produrre warning informativi.
...
- Scanner/tool: https://www.zaproxy.org/docs/
