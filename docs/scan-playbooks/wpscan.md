...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner WPScan.
- **Categoria:** CMS
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con WPScan.
...
## Errori comuni
- Enumerazione plugin/tema può rilevare componenti non realmente attivi.
...
- Scanner/tool: https://wpscan.com/docs/
