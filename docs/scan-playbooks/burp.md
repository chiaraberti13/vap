...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Burp Scanner.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Burp Scanner.
...
## Errori comuni
- Scanner automatico richiede sempre validazione manuale.
...
- Scanner/tool: https://portswigger.net/burp/documentation
