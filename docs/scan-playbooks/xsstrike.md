...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner XSStrike.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con XSStrike.
...
## Errori comuni
- Payload riflessi non necessariamente sfruttabili.
...
- Scanner/tool: https://github.com/s0md3v/XSStrike
