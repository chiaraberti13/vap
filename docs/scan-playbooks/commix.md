...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner Commix.
- **Categoria:** App
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con Commix.
...
## Errori comuni
- Comandi filtrati lato server possono mascherare vulnerabilità reali.
...
- Scanner/tool: https://github.com/commixproject/commix/wiki
