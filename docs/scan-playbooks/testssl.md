...
## Teoria minima
- **Obiettivo formativo:** Comprendere output operativo dello scanner testssl.sh.
- **Categoria:** Infra
- **Livello consigliato:** intermediate
- **Mappature:** OWASP A05, A06 · MITRE TA0007

## Quando usarla
Quando serve un'analisi mirata con testssl.sh.
...
## Errori comuni
- Cipher legacy segnalati anche quando mitigati da policy applicative.
