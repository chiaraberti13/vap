...
- [ ] **Warning tecnici residui da dipendenze terze parti (rilevati il 2026-04-04):** restano warning non bloccanti provenienti da librerie esterne (`dateutil`, `reportlab`, `passlib`, `python-jose`) su API Python deprecate; pianificare upgrade/version pin o filtri warning mirati nel backlog di compatibilità runtime.
