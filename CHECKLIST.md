...
1. **C1** → WPScan (priorità massima tra i nuovi scanner)
2. **C2–C5** → wafw00f, testssl, theHarvester, Arjun
3. **C6–C9** → DalFox, httpx, Katana, NoSQLMap
4. **E1–E4** → scan types e configurazione
